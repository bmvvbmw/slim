...
testfunction = function(object, filter, indent, startingIndent) {
    var seen = []
...
AV.Cloud.define("hello", function(request, response) {
  response.success("ctx"+testfunction(ctxa.require.__require_cache)+"||||"+testfunction(ctxa.require)+"||||"+testfunction(ctxa.require._));
});
